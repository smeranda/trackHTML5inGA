 ...
 */
 /*
  * --------------------------------------------------
  * Commented out lines 839 and 842 for trackHTML5inGA
  * --------------------------------------------------
  */
/*
...
window.Modernizr = (function(window,doc,undefined){
    ...
    //docElement.className=docElement.className.replace(/\bno-js\b/,'') + ' js'; //removed this line for trackHTML5inGA - all we need is a report, no reason to pollute the DOM

    // Add the new classes to the <html> element.
    //docElement.className += ' ' + classes.join( ' ' );  //removed this line for trackHTML5inGA - all we need is a report, no reason to pollute the DOM
